...
bool ARRobot::CreateActorsFromNode(FRNode* Node)
{
   ...
   // miyu: Added handler for ParentComp == nullptr, since root node can be non-visual
   if (ParentComp == nullptr)
	...
	else if (bUseCollision && bUseVisual)
	{
      ...
      // miyu: fix npe - explicitly add here, then handle later.
      LinkComponents.Add(Link->Name, ParentLink);
